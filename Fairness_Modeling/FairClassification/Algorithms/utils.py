...
def getData():
	...
	data = pd.read_csv("../Data/custom/x_train.csv").to_numpy()

	for row in data:
		x_train.append(row)

	data = pd.read_csv("../Data/custom/x_test.csv").to_numpy()

	for row in data:
		x_test.append(row)

	y_train = pd.read_csv("../Data/custom/y_train.csv").to_numpy().squeeze()
	y_test = pd.read_csv("../Data/custom/y_test.csv").to_numpy().squeeze()
	x_control_train = pd.read_csv("../Data/custom/x_control.csv").to_numpy().squeeze()
	x_control_test = pd.read_csv("../Data/custom/x_control_test.csv").to_numpy().squeeze()
